...
# Example script to acknowledge incident.
...
body = {'AcknowledgementParameters': {'AcknowledgeContactAlias': 'alias'}}

incident = icm_api.update_incident(incident_id='TICKET_ID', body=body, entity='AcknowledgeIncident')
